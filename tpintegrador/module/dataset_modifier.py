...
def airport_dataset(route, custom_route):
    ...
    with open(route, encoding= 'utf-8') as airport_file, open(custom_route, 'w', encoding= 'utf-8') as custom_file:
...
def airport_with_provs_dataset(route, custom_route, definitive_route):
    ...
    with open(route, encoding= 'utf-8') as argentina_file, open(custom_route, encoding= 'utf-8') as custom_file, open(definitive_route, 'w', encoding= 'utf-8') as file_definitive:
...
def internet_dataset(route, custom_route):
    ...
    the value = "NO" '''
    with open(route, encoding= 'utf-8') as connection_file, open(custom_route, 'w', encoding= 'utf-8') as custom_file:
...
def lakes_dataset(route, custom_route):
    ...
    with open(route) as lakes_file, open(custom_route, 'w') as custom_file:
...
def census_dataset(route, custom_route):
    ...
    with open(route, encoding= 'utf-8') as poblation_file, open(custom_route, 'w', encoding= 'utf-8') as custom_file:
